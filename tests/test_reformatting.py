...
class TestReformatting:
    ...
    def test_convert_features_to_plate_format_96_well(self):
        ...
        plate_data, cols, rows = convert_features_to_plate_format(features, 96, "tm")  # ty:ignore[invalid-argument-type]
        ...
        plate_data, _, _ = convert_features_to_plate_format(features, 96, "max_derivative_value")  # ty:ignore[invalid-argument-type]
    ...
    def test_convert_features_to_plate_format_raises_keyerror_for_missing_feature(self):
        ...
        with pytest.raises(KeyError):
            convert_features_to_plate_format(features, 96, "max_derivative_value")  # ty:ignore[invalid-argument-type]
    ...
    def test_convert_features_to_plate_format_raises_keyerror_for_nonexistent_feature(self):
        ...
        with pytest.raises(KeyError):
            convert_features_to_plate_format(features, 96, "nonexistent_feature")  # ty:ignore[invalid-argument-type]
